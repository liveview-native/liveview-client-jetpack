 ...
 * ```
 */
internal class LinkDTO private constructor(props: Properties) :
    ComposableView<LinkDTO.Properties>(props) {
    ...
    internal class Builder : ComposableBuilder() {
        ...
        fun build() = LinkDTO(Properties(navigatePath, commonProps))
    }
...
internal object LinkDtoFactory : ComposableViewFactory<LinkDTO>() {
    override fun buildComposableView(
        attributes: ImmutableList<CoreAttribute>,
        pushEvent: PushEvent?,
        scope: Any?,
    ): LinkDTO = attributes.fold(LinkDTO.Builder()) { builder, attribute ->
        when (attribute.name) {
