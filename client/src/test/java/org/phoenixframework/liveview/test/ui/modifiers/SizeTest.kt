...
class SizeTest : ModifierBaseTest() {
    ...
    fun matchParentSizeTest() {
        ...
        composeRule.setContent {
            Box {
                result =
                    modifiersParser.run { Modifier.fromStyleName("matchParentSizeTest", this@Box) }
    ...
    fun weightRowTest() {
        ...
        composeRule.setContent {
            Row {
                result = modifiersParser.run { Modifier.fromStyleName("weightRowTest", this@Row) }
    ...
    fun weightColumnTest() {
        ...
        composeRule.setContent {
            Column {
                result =
                    modifiersParser.run { Modifier.fromStyleName("weightColumnTest", this@Column) }
                modifier = Modifier.then(Modifier.weight(0.5f, false))
            }
        }
        assert(result != null)
