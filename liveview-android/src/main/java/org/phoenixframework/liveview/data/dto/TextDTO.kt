...
class TextDTO private constructor(builder: Builder) : ComposableView() {
    ...
    class Builder {
         ...
         *
         * @param color The color to be applied to the text. The color must be specified as a string in
         *   the format "0xFFBB86FC", where FF, BB, 86, and FC are the red, green, blue, and alpha
         *   (transparency) components of the color in hexadecimal format. If an empty string or any
         *   other value is provided, the color will not be changed.
         */
         ...
         *
         * @param fontSize The font size to be applied, in sp. The font size must be a positive integer.
         *   If an empty string    is provided, the font size will not be changed.
         */
         ...
         *
         * @param fontStyle The font style to be applied. Accepted values are "normal" for NormalText
         *   and "italic" for ItalicText. If an empty string or any other value is provided, the font
         *   style will be set to Italic.
         */
         ...
         *
         * @param fontWeight The font weight to be applied. Accepted values are "W100" for Thin, "W200"
         *   for ExtraLight, "W300" for Light, "W400" for Normal (regular/plain), "W500" for Medium,
         *   "W600" for SemiBold, "W700" for Bold, "W800" for ExtraBold, and "W900" for Black. If an
         *   empty string or any other value is provided, the font weight will be set to Normal.
         */
         ...
         *
         * @param letterSpacing The letter spacing to be applied, in sp. The letter spacing must be a
         *   positive integer. If an empty string or any other value is provided, the letter spacing
         *   will not be changed.
         */
         ...
         *
         * @param textAlign the alignment to set. Valid values are "left", "right", "center", "justify",
         *   "start", and "end".   If an invalid value is provided, the default alignment is "start".
         */
         ...
         *
         * @param lineHeight The line height to be applied, in sp. The line height must be a positive
         *   integer. If an empty string or any other value is provided, the line height will not be
         *   changed.
         */
         ...
         *
         * @param overflow the overflow behavior to set. Valid values are "clip" and "ellipsis". If an
         *   invalid value is provided, the default behavior is "visible".
         */
